...
brew "watchman"
# "General-purpose data compression with high compression ratios"
brew "xz"
...
cask "applepi-baker"
# en-source electronics prototyping platform
cask "arduino"
...
cask "caffeine"
# A tool to show Mac caps lock status.
cask "captin"
...
cask "macdown"
# Utility to combine binary content files after download
cask "macpar-deluxe"
...
# en-source cross-platform multimedia player
cask "vlc"
